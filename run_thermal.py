...
CLASSWORK_ROOT = Path(__file__).resolve().parent
COURSE_ROOT = CLASSWORK_ROOT.parent
...
for path in (CLASSWORK_ROOT, A3_ROOT, A3_Q2_ROOT):
    path_str = str(path)
...
def main() -> None:
    if len(sys.argv) > 1:
        ...
        case_file = CLASSWORK_ROOT / "inputs" / "thermal_frame_combined.json"
